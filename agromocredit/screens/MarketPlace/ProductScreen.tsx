    ...
    contentDisplay = (
      <View style={styles.contentContainer}>
        ...
        <View style={styles.productContainer}>
          ...
          >{`Supplier: ${product.supplierName}`}</Text>
          ...
          {product.price <= maxLoan ? (
            <>
              ...
              <Text style={styles.categoryText}>
                You can purchase this product on credit
              </Text>
            </>
          ) : (
            <>
              ...
              />
              <Text style={styles.categoryText}>
                Your credit score doesnt qualify for a credit purchase
              </Text>
            </>
          )}
        </View>
    ...
    <SafeAreaView style={screenStyles.creditScreenContainer}>
      ...
      >
        <TouchableOpacity
          ...
          style={styles.banner}
        ></TouchableOpacity>
        <View style={styles.bottomContent}>{contentDisplay}</View>
      </ImageBackground>
    </SafeAreaView>
  )
}
